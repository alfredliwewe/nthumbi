...
<head>
	...
	<link rel="icon" href="../img/<?=$system->logo;?>">
...
<body style="padding: 0;">
	<div class="w3-row">
		<div class="w3-col m2 bg-info" id="leftNav" style="height: 500px;overflow-y: auto;">
			<br>
			<center>
				<img src="../img/<?=$system->logo;?>" width="60">
			</center>
		...
		<div class="w3-col m10" id="rightNav" style="overflow-y: auto;">
			...
			<div class="w3-row w3-padding-jumbo tt" id="home">
				<div style="padding-top: 40px;padding-bottom: 20px;">
					<center>
						<img src="../img/<?=$system->logo;?>" width="60"><br><br>
						<font class="w3-xlarge"><?=$system->name;?></font>
					</center>
				</div>
			...
			<div class="w3-row w3-padding-jumbo tt" id="register" style="display: none;">
				...
				<table id="example" class="display" style="width:80%">
					<thead>
						<tr>
							<th><input type="checkbox" onchange="selectStudents(this)"></th><th>#</th><th>Reg Number</th><th>Fullname</th><th>Status</th><th>Action</th>
						</tr>
					</thead>
					<tbody id="all_students">
						...
						while ($row = $read->fetchArray()) {
							$row_id = $row['id'];
							echo "<tr><td><input type=\"checkbox\" class='studentSelect' data=\"{$row['id']}\"></td><td>$i</td><td>{$row['regnumber']}</td><td>{$row['fullname']}</td><td id='student_status$row_id'>{$row['status']}</td><td id='row$row_id'>";
